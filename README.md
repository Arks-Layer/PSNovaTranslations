...
<i>While we appreciate the efforts of those who don't speak Japanese (through Google translate and the like), we would like for only those who have a grasp of the Japanese language to submit edits to those, as we are doing a translation, and not a transliteration. ありがとう～ (*＾▽＾)／</i>
